About glue-vispy-viewers-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/glue-vispy-viewers-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5570&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/glue-vispy-viewers-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `glue-vispy-viewers` can be installed with `conda`:
...
It is possible to list all of the versions of `glue-vispy-viewers` available on your platform with `conda`:
...
```
mamba search glue-vispy-viewers --channel conda-forge
```
...
mamba repoquery search glue-vispy-viewers --channel conda-forge

# List packages depending on `glue-vispy-viewers`:
mamba repoquery whoneeds glue-vispy-viewers --channel conda-forge

# List dependencies of `glue-vispy-viewers`:
mamba repoquery depends glue-vispy-viewers --channel conda-forge
```
